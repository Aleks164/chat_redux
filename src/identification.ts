...
export function identificationWindow() {
  ...
  mainEl.innerHTML = `<div id="mainWindow"><input id="modalInput" type="text" placeholder="Name" value="Anonim"><input id="modalsubmit" type="submit" value="Confirm name"></div>`;
